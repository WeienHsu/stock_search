...
_LIGHT = {
    ...
    "signal_buy": morandi.RED,
    "signal_sell": morandi.GREEN,
...
_DARK = {
    ...
    "signal_buy": dark_pal.RED,
    "signal_sell": dark_pal.GREEN,
