...
MORANDI_DOWN = "#4CAF82"   # 跌 / 賣出訊號
MORANDI_UP   = "#E85820"   # 漲 / 買進訊號
GREEN  = MORANDI_DOWN      # DEPRECATED: use MORANDI_DOWN
RED    = MORANDI_UP        # DEPRECATED: use MORANDI_UP
SEMANTIC_UP_TEXT   = MORANDI_UP
SEMANTIC_DOWN_TEXT = MORANDI_DOWN
BLUE   = "#5B9BD5"
ORANGE = "#E8A45A"
PURPLE = "#A98ECC"
BROWN  = "#C4A870"
